...
describe('Character API endpoints', () => {
    ...
    afterEach((done) => {
        Character.deleteMany({ charactername: ['mycharacter', 'anothercharacter'] })
        .then(() => {
            done()
        })
    })
    ...
    it('should get one character', (done) => {
        ...
        .end((err, res) => {
            ...
            expect(res.body.charactername).to.equal('mycharacter')
            done()
        })
    })
    ...
    it('should delete a character', (done) => {
        ...
        .end((err, res) => {
            ...
            Character.findOne({charactername: 'mycharacter'}).then(character => {
